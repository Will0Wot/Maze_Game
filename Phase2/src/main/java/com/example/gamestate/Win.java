...
/**
 * Represents the win state in the game. This state is activated when the player wins the game.
 * It displays a congratulatory message, options to restart the game or exit, and a distinctive background.
 *
 * @author Tom
 */
public class Win extends State {

    private WinButton[] b = new WinButton[2];
    ...
    /**
     * Constructs a Win state for the given game.
    ...
    private void createBackground() {
        try {
            ...
            topImg = ResourceLoader.getImage(ResourceLoader.MENU_TOP_YELLOW);
        } catch (IOException e) {
    ...
    private void createButtons(){
        b[0] = new WinButton(120,100,0,Gamestate.PLAYING);
        b[1] = new WinButton(120,-100,1,Gamestate.EXIT);
//        //test win and lose
...
//        b[1] = new MenuButton(120,-100,1,Gamestate.DEFEAT);
     ...
     */
    public boolean isInside(MouseEvent e, WinButton mb){
